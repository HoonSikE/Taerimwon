...
//        searchList2.add(UrnItem("기본(검정)", R.drawable.img_bone1_0))
        searchList2.add(UrnItem("ZEN사각합골진공함-HG-3-8228", R.drawable.img_bone1_1))
    }
...
//        searchList3.add(UrnItem("기본(검정)", R.drawable.img_bone2_0))
        searchList3.add(UrnItem("합골금띠 HG-1 4612", R.drawable.img_bone2_1))
        searchList3.add(UrnItem("합골실버십장생 HG-2 4914", R.drawable.img_bone2_2))
    }
}