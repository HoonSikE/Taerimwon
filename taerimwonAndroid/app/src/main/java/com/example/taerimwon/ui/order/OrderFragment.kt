...
//        if(ApplicationClass.prefs.saveInfo) {
        ...
        binding.editTextStartArea.setText(ApplicationClass.prefs.startArea)
...
//            .commit()
    ...
    private fun setOnClickListeners() {
        ...
        binding.imageOrderToHomeFragment.setOnClickListener{
    ...
    private fun addTextChangedListener() {
        ...
        // 발주 장소
        // 발주자 정보
        binding.editTextStartArea.addTextChangedListener(object : TextWatcher {
            override fun beforeTextChanged(s: CharSequence?, start: Int, count: Int, after: Int) {
                // 이전 텍스트 변경 이벤트
            }
            ...
            override fun onTextChanged(s: CharSequence?, start: Int, before: Int, count: Int) {
                // 텍스트 변경 이벤트
                ApplicationClass.prefs.startArea =
                    s?.toString() ?: "" // editText의 텍스트를 가져오고 null이면 빈 문자열로 처리
                println("ApplicationClass.prefs.startArea :" + ApplicationClass.prefs.startArea)
            }
