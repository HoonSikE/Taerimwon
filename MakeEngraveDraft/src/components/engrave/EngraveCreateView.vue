...
.scroll-container {
  ...
  background-color: #cfcfcf; /* 선택 시 배경색을 변경 */
  border-radius: 5px;
...
.link-item {
  ...
  padding-left: 5px;
  padding-right: 5px;
  background-color: #212121; /* 선택 시 배경색을 변경 */
  border-radius: 5px;
}
...
.link-item.selected {
  border: 3px solid #000000; /* 선택 시 보더 스타일을 추가하여 선택 표시 */
  background-color: #545454a6; /* 선택 시 배경색을 변경 */
}
</style>